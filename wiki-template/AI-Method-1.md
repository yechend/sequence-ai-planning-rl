...
- **Strong Performance in Constrained Settings**  
  Achieves high win rates (up to **85%**, and **34/40** in #submission conditions using only 1-second decision windows.
